package com.yahoo.inmind.comm.generic.control.eventbus.util;
...
public class ErrorDialogManager {
    ...
    protected static final String TAG_ERROR_DIALOG = "com.yahoo.inmind.comm.generic.control.eventbusbus.error_dialog";
    protected static final String TAG_ERROR_DIALOG_MANAGER = "com.yahoo.inmind.comm.generic.control.eventbusbus.error_dialog_manager";

    public static final String KEY_TITLE = "com.yahoo.inmind.comm.generic.control.eventbusbus.errordialog.title";
    public static final String KEY_MESSAGE = "com.yahoo.inmind.comm.generic.control.eventbusbus.errordialog.message";
    public static final String KEY_FINISH_AFTER_DIALOG = "com.yahoo.inmind.comm.generic.control.eventbusbus.errordialog.finish_after_dialog";
    public static final String KEY_ICON_ID = "com.yahoo.inmind.comm.generic.control.eventbusbus.errordialog.icon_id";
    public static final String KEY_EVENT_TYPE_ON_CLOSE = "com.yahoo.inmind.comm.generic.control.eventbusbus.errordialog.event_type_on_close";
