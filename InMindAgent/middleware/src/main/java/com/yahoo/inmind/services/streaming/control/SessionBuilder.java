...
public class SessionBuilder {
	...
	private StreamingSurfaceView mStreamingSurfaceView = null;
	...
	public Session build() {
		...
		case VIDEO_H264:
            ...
            //ojrl: we need this since it gives better resolution
			stream.setStreamingMethod( MediaStream.MODE_MEDIACODEC_API_2 );
			if (mContext!=null) 
				stream.setPreferences(PreferenceManager.getDefaultSharedPreferences(mContext));
		...
		if (session.getVideoTrack()!=null) {
			...
			video.setSurfaceView(mStreamingSurfaceView);
	 ...
	 **/
	public SessionBuilder setSurfaceView(StreamingSurfaceView streamingSurfaceView) {
		mStreamingSurfaceView = streamingSurfaceView;
		return this;
	}
	...
	/** Returns the SurfaceView set with {@link #setSurfaceView(StreamingSurfaceView)}. */
	public StreamingSurfaceView getSurfaceView() {
		return mStreamingSurfaceView;
	}
