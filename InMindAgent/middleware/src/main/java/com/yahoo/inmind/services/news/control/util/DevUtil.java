...
public class DevUtil {
	...
	private static String getAndroidID(){
		return Secure.getString(ReaderController.get().getContentResolver(), Secure.ANDROID_ID);
	} 
	/** 
	...
	public static String getDeviceID(){
		...
		WifiManager wifiMan = (WifiManager) ReaderController.get().getSystemService(Context.WIFI_SERVICE);
	...
	private static String getUUID(){
		String uuid = "";
		SharedPreferences sharedPrefs = ReaderController.get().getSharedPreferences(UUID_FILE, Context.MODE_PRIVATE);
