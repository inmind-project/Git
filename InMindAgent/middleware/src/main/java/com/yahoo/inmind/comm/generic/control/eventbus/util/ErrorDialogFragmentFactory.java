...
/**
 * Factory to allow injecting a more complex exception mapping; typically you would subclass one of {@link ErrorDialogFragmentFactory.Honeycomb} or
 * {@link ErrorDialogFragmentFactory.Support}.
 */
public abstract class ErrorDialogFragmentFactory<T> {
    ...
    public static class Support extends ErrorDialogFragmentFactory<Fragment> {
        ...
        protected Fragment createErrorFragment(ThrowableFailureEvent event, Bundle arguments) {
            ...
            errorFragment.onCreateDialog(arguments);
