...
public class RtspClient {
	...
	public void setDestination(String destinationString) {
		mTmpParameters.destination = destinationString;
	}
	...
	/**
	 * Connects to the RTSP server to publish the stream, and then effectively starts streaming.
	...
	public void startStream() {
		...
		mHandler.post(new Runnable () {
			...
			public void run() {
				...
				mParameters.session.setDestination( mTmpParameters.destination );
	...
	private void sendRequestAnnounce() throws IllegalStateException, SocketException, IOException {
		...
		for( String destination : mParameters.session.getDestinations() ) {
            String body = mParameters.session.getSessionDescription( destination );
