...
public class IMEvent {
    ...
    final static String featureDurationFromBeginning = "duration"; //double. Duration from beginning.
    final static String featureDurationOfSample = "sample_duration"; //double. Duration of this sample.
